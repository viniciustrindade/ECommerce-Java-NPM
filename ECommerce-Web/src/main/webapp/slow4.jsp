<!-- saved from url=(0162)http://stevesouders.com/cuzillion/?c0=hc1hfff3_0_f&c1=hj1hfff2_3_f&c2=bi1hfff2_0_f&c3=bi1hfff2_0_f&c4=bi1hfff2_0_f&c5=bi1hfff2_0_f&c6=bi1hfff2_0_f&t=1376352729337 -->
<html>
<head>
    ...
    <!-- external stylesheet<p style='margin: 0 4px 4px 12px; font-size: 0.8em;'> on domain1 with a 3 second delay using HTML tags -->
    <link rel="stylesheet" type="text/css" href="./slow4_files/resource.cgi">

    <!-- external script<p style='margin: 0 4px 4px 12px; font-size: 0.8em;'> on domain1 with a 2 second delay with a 3 second execute time using HTML tags -->
    <script type="text/javascript" src="./slow4_files/resource(1).cgi"></script>
...
<div style="background: #333; color: white; padding: 8px;">
    ...
    <font style="font-size: 2em; font-weight: bold; margin-right: 10px;"><a href="http://stevesouders.com/cuzillion/"
            ...
            border="0" src="./slow4_files/logo-32x32.gif">&nbsp;Cuzillion</a></font><i>'cuz there are a zillion pages to
    check</i>
</div>
...
<div id="content" style="margin: 8px;">
    ...
    <img src="./slow4_files/resource(2).cgi">

    <!-- image<p style='margin: 0 4px 4px 12px; font-size: 0.8em;'> on domain1 with a 2 second delay using HTML tags -->
    <img src="./slow4_files/resource(3).cgi">

    <!-- image<p style='margin: 0 4px 4px 12px; font-size: 0.8em;'> on domain1 with a 2 second delay using HTML tags -->
    <img src="./slow4_files/resource(4).cgi">

    <!-- image<p style='margin: 0 4px 4px 12px; font-size: 0.8em;'> on domain1 with a 2 second delay using HTML tags -->
    <img src="./slow4_files/resource(5).cgi">

    <!-- image<p style='margin: 0 4px 4px 12px; font-size: 0.8em;'> on domain1 with a 2 second delay using HTML tags -->
    <img src="./slow4_files/resource(6).cgi">
    ...
    <div id="pageavatar" style="float: left; width: 310px; margin-right: 30px;">
        ...
        <div style="background: #CCC; border: 1px solid black; ">
            ...
            <div class="drop"
                ...
                <ul style="margin: 0; padding: 0;" id="inhead">
                    <li onclick="enableEdit()" id="acomp1" class="sortitem extcss"
                        style="cursor: move; list-style: none; border-width: 2px; border-style: solid; border-color: #555; margin: 4px;">
                        <div id="acomp1Div" class="component extcss"
                             style="padding: 2px; font-family: Arial; text-align: center; display: block; text-decoration: none; color: white; background: #930000; text-align: left;">
                            <span>external stylesheet<p style="margin: 0 4px 4px 12px; font-size: 0.8em;"> on domain1
                                with a 3 second delay using HTML tags</p></span></div>
                    </li>
                    <li onclick="enableEdit()" id="acomp2" class="sortitem extjs"
                        ...
                        <div id="acomp2Div" class="component extjs"
                            ...
                            <span>external script<p style="margin: 0 4px 4px 12px; font-size: 0.8em;"> on domain1 with a
                                2 second delay with a 3 second execute time using HTML tags</p></span></div>
                    </li>
                </ul>
            ...
            <div class="drop"
                ...
                <ul style="margin: 0; padding: 0;" id="inbody">
                    <li onclick="enableEdit()" id="acomp3" class="sortitem image"
                        style="cursor: move; list-style: none; border-width: 2px; border-style: solid; border-color: #555; margin: 4px;">
                        <div id="acomp3Div" class="component image"
                    ...
                    <li onclick="enableEdit()" id="acomp4" class="sortitem image"
                        style="cursor: move; list-style: none; border-width: 2px; border-style: solid; border-color: #555; margin: 4px;">
                        <div id="acomp4Div" class="component image"
                             style="padding: 2px; font-family: Arial; text-align: center; display: block; text-decoration: none; color: white; background: #000080; text-align: left;">
                            <span>image<p style="margin: 0 4px 4px 12px; font-size: 0.8em;"> on domain1 with a 2 second
                                delay using HTML tags</p></span></div>
                    </li>
                    <li onclick="enableEdit()" id="acomp5" class="sortitem image"
                        style="cursor: move; list-style: none; border-width: 2px; border-style: solid; border-color: #555; margin: 4px;">
                        <div id="acomp5Div" class="component image"
                             style="padding: 2px; font-family: Arial; text-align: center; display: block; text-decoration: none; color: white; background: #000080; text-align: left;">
                            <span>image<p style="margin: 0 4px 4px 12px; font-size: 0.8em;"> on domain1 with a 2 second
                                delay using HTML tags</p></span></div>
                    </li>
                    <li onclick="enableEdit()" id="acomp6" class="sortitem image"
                        style="cursor: move; list-style: none; border-width: 2px; border-style: solid; border-color: #555; margin: 4px;">
                        <div id="acomp6Div" class="component image"
                             style="padding: 2px; font-family: Arial; text-align: center; display: block; text-decoration: none; color: white; background: #000080; text-align: left;">
                            <span>image<p style="margin: 0 4px 4px 12px; font-size: 0.8em;"> on domain1 with a 2 second
                                delay using HTML tags</p></span></div>
                    </li>
                    <li onclick="enableEdit()" id="acomp7" class="sortitem image"
                        style="cursor: move; list-style: none; border-width: 2px; border-style: solid; border-color: #555; margin: 4px;">
                        <div id="acomp7Div" class="component image"
                             style="padding: 2px; font-family: Arial; text-align: center; display: block; text-decoration: none; color: white; background: #000080; text-align: left;">
                            <span>image<p style="margin: 0 4px 4px 12px; font-size: 0.8em;"> on domain1 with a 2 second
                                delay using HTML tags</p></span></div>
                    </li>
        ...
        <div id="loadtime" style="text-align: left; margin-top: 10px;">page load time: 6886 ms</div>
        <div id="loadedscripts" style="text-align: left; margin-top: 10px; width: 300px; font-size: 0.9em;">
            <nobr>6847ms: "http://1.cuzillion.com/bin/resource.cgi?type=js&amp;sleep=2&amp;jsdelay=3&amp;n=2&amp;t=1376427469"
                done
            </nobr>
        </div>
    </div>
        ...
        <div id="pagesubmit" style="text-align: left;">
            <nobr>
                ...
                <input type="button" value="Reload"
                       onclick="reloadPage(&#39;/cuzillion/?c0=hc1hfff3_0_f&amp;c1=hj1hfff2_3_f&amp;c2=bi1hfff2_0_f&amp;c3=bi1hfff2_0_f&amp;c4=bi1hfff2_0_f&amp;c5=bi1hfff2_0_f&amp;c6=bi1hfff2_0_f&amp;t=1376427469&#39;)">&nbsp;&nbsp;
