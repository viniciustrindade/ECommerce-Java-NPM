<!-- saved from url=(0082)http://stevesouders.com/cuzillion/?c0=bi1hfff2_0_f&c1=bj1hfft0_5_t&t=1376353153666 -->
<html>
<head>
...
<div style="background: #333; color: white; padding: 8px;">
    ...
    <font style="font-size: 2em; font-weight: bold; margin-right: 10px;"><a href="http://stevesouders.com/cuzillion/"
            ...
            border="0" src="./slow2_files/logo-32x32.gif">&nbsp;Cuzillion</a></font><i>'cuz there are a zillion pages to
    check</i>
</div>
...
<div id="content" style="margin: 8px;">
    ...
    <img src="./slow2_files/resource.cgi">

    <!-- external script<p style='margin: 0 4px 4px 12px; font-size: 0.8em;'> on domain1 with a 5 second execute time using HTML tags with defer with async -->
    <script type="text/javascript" defer="" async="" src="./slow2_files/resource(1).cgi"></script>
    ...
    <div id="pageavatar" style="float: left; width: 310px; margin-right: 30px;">
                    ...
                    <li onclick="enableEdit()" id="acomp2" class="sortitem extjs"
                        ...
                        <div id="acomp2Div" class="component extjs"
                            ...
                            <span>external script<p style="margin: 0 4px 4px 12px; font-size: 0.8em;"> on domain1 with a
                                5 second execute time using HTML tags with defer with async</p></span></div>
                    </li>
                </ul>
        ...
        <div id="loadtime" style="text-align: left; margin-top: 10px;">page load time: 5119 ms</div>
        <div id="loadedscripts" style="text-align: left; margin-top: 10px; width: 300px; font-size: 0.9em;">
            <nobr>5096ms: "http://1.cuzillion.com/bin/resource.cgi?type=js&amp;sleep=0&amp;jsdelay=5&amp;n=2&amp;t=1376427447"
                done
            </nobr>
        </div>
    </div>
        ...
        <div id="pagesubmit" style="text-align: left;">
            <nobr>
                ...
                <input type="button" value="Reload"
                       onclick="reloadPage(&#39;/cuzillion/?c0=bi1hfff2_0_f&amp;c1=bj1hfft0_5_t&amp;t=1376427447&#39;)">&nbsp;&nbsp;
